! function(modules) {
    ...
    function utf8FillLast(buf) {
        var p = this.lastTotal - this.lastNeed,
            r = function(self, buf, p) { if (128 != (192 & buf[0])) return self.lastNeed = 0, "ï¿½"; if (self.lastNeed > 1 && buf.length > 1) { if (128 != (192 & buf[1])) return self.lastNeed = 1, "ï¿½"; if (self.lastNeed > 2 && buf.length > 2 && 128 != (192 & buf[2])) return self.lastNeed = 2, "ï¿½" } }(this, buf);
    ...
    }, StringDecoder.prototype.end = function(buf) { var r = buf && buf.length ? this.write(buf) : ""; return this.lastNeed ? r + "ï¿½" : r }, StringDecoder.prototype.text = function(buf, i) {
    ...
    var BigNumber = function clone(configObject) {
        var div, convertBase, parseNumeric, random53bitInt, basePrefix, dotAfter, dotBefore, isInfinityOrNaN, whitespaceOrPlus, P = BigNumber.prototype = { constructor: BigNumber, toString: null, valueOf: null },
            ...
            MODULO_MODE = 1,
            POW_PRECISION = 0,
            FORMAT = { prefix: "", groupSize: 3, secondaryGroupSize: 0, groupSeparator: ",", decimalSeparator: ".", fractionGroupSize: 0, fractionGroupSeparator: "Â ", suffix: "" },
